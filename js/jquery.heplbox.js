...
(function ($) {
	...
	$.fn.heplbox = function (oGivenSettings) {
		...
		/**
		 * Crée l'overlay et le conteneur de l'image si ils n'existent pas
		 * La fonction de fermeture de la box est lancée lors d'un click hors de la box (sur l'overlay)
		 */
		var setup = function () {
		...
		/**
		 * Anule l'événement par défaut du clic sur une image (pour l'empecher de charger l'image sur un nouvel onglet)
		 * Récupère le chemin de l'image et ouvre la box
		...
		/**
		 * Ouvre la box et applique un fond flou en plus de l'overlay au site qui apparait en fondu
		 */
		...
		/**
		 * Crée la balise img avec le chemin de l'image récupéré plus tot
		 * Place cette balise dans le conteneur (la box)
		 */
		...
		/**
		 * Fait disparaitre la box, l'overlay, le flou et l'image en fondu
		 */
		...
		/**
		 * Charge l'image d'après et l'affiche sauf si le nombre d'éléments est égal à 1. Sinon ferme la box
		...
		/**
		 * Lance la fonction d'initialisation de l'overlay et de la box
		 */
		setup();
